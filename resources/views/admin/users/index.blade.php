...
<div class="d-flex justify-content-between mb-4">
    ...
    <a href="{{ route('admin.users.create') }}" class="btn btn-primary btn-sm px-2 py-1 text-nowrap"><i class="bi bi-plus-lg me-1"></i>Add User</a>
</div>
<div class="card">
    <div class="card-body">
        <div class="table-responsive w-100">
            <table class="table table-hover w-100" id="usersTable" style="min-width: 0;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.users.edit', $admin) }}" class="btn btn-sm btn-outline-warning p-0 px-2"><i class="bi bi-pencil"></i></a>
                            ...
                            <form action="{{ route('admin.users.destroy', $admin) }}" method="POST" class="d-inline" onsubmit="return confirm('Remove user?')">
                                @csrf
                                @method('DELETE')
                                <button class="btn btn-sm btn-outline-danger p-0 px-2"><i class="bi bi-trash"></i></button>
                            </form>
                            @endif
                        </td>
                    </tr>
...
@endsection
@push('scripts')
<script>$('#usersTable').DataTable({scrollX:true,autoWidth:false,width:'100%'});</script>
@endpush
