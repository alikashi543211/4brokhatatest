...
<div class="card">
    <div class="card-body">
        <div class="table-responsive w-100">
            <table class="table table-hover w-100" id="stmtTable" style="min-width: 0;">
...
@endsection
@push('scripts')
<script>$('#stmtTable').DataTable({paging:false,searching:true,info:false,scrollX:true,autoWidth:false,width:'100%'});</script>
@endpush
